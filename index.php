...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['username']) && !empty($_POST['message'])) :
    ...
    $db->query(
        "INSERT INTO posts(name, message) values('$user', '$message')"
...
?>
    <div class="card">
        <div class="card-header">
            <span><?php echo $username;   // TO DO: display the value of username for this post ?></span>
        </div>
        <div class="card-body">
            <p class="card-text"><?php  echo $message; // TO DO: display the message for this post ?></p>
        </div>
    </div>
    <hr>
<?php
